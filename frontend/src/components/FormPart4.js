                    ...
                    <tr>
                        ...
                        <td style={{ width: "100%", display: "flex", flexDirection: "column" }} className='input_label_gapper' >
                            ...
                            <div style={{ display: "flex", flexWrap: "wrap" }}>
                                ...
                                <input type="text" id="reason6" name="Key_Reason_Preventing_loan" />
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colSpan={5}>
                            <input type='text' id='secQuestion' name='source_of_credit_form' />
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colSpan={5} style={{ width: "100%", display: "flex", flexDirection: "column" }} className='input_label_gapper' >
                            ...
                            <div style={{ display: "flex", flexWrap: "wrap" }}>
                                ...
                                <input type="text" id="outcome6" name="applied_loan_outcome" />
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td className='form4_styling'>
                            <input type='text' id='fourthQuestion' name='reason_of_rejection' />
                        </td>
                    </tr>
                </thead>
