...
export async function dataaction({ request }) {
  ...
  const submission = {
    ...
    TOP_THREE_PRODUCTS:[formData.get("TOP_THREE_PRODUCTS-1"),formData.get("TOP_THREE_PRODUCTS-2"),formData.get("TOP_THREE_PRODUCTS-3")],
    ...
    have_CA_audited_financial_statement: formData.get("have_CA_audited_financial_statement"),
    ...
    Effluent_Treatment_Constraint: formData.get("Effluent_Treatment_Constraint"),
        ...
        >
          ...
          >
            ...
            <div className="div-style" style={{ borderTop: 0 }}>
              ...
              >
                <div>
                  <label htmlFor="Firm_Registered" style={{ fontWeight: "500" }}>
                    Yes
                  </label>
                  <input
                    type="radio"
            ...
            <div className="div-style" style={{ borderTop: 0 }}>
              ...
              <div className="checkboxes">
                <div>
                  <label htmlFor="Udyam_Registration" style={{ fontWeight: "500" }}>
                    Yes
                  </label>
                  <input
                    type="radio"
            ...
            <div className="div-style" style={{ borderTop: 0 }}>
              ...
              <div className="checkboxes">
                <div>
                  <label htmlFor="Operations_seasonal_yes" style={{ fontWeight: "500" }}>
                    Yes
                  </label>
                  <input
                ...
                <div>
                  <label htmlFor="Operations_seasonal_no" style={{ fontWeight: "500" }}>
                    No
                  </label>
                  <input
            ...
            <div className="div-style" style={{ borderTop: 0 }}>
              ...
              <div style={{display:"flex",padding:"1%",flexDirection:"column",borderRight:"2px solid black"}}>
                ...
                name="Permanent_Emoployee"
                 id="time" placeholder="" style={{width:"50%",border:"transparent"}} />
                </div>
                <div>
            ...
            <div className="div-style" style={{ borderTop: 0 }}>
              <div className="inner-div-tag">
              Whether Loan is adequate for your operations? If not, 
please indicate the amount of loan required for both term 
...
{" "}
              ...
              >
                <div className="inner-div-tag">
                Any innovation or R&D 
undertaken on your own or in 
...
scheme{" "}
            ...
            <div className="div-style" style={{ borderTop: 0 }}>
              <label className="inner-div-tag">Do you have PAN 
card on the name 
of your company? </label>
            ...
            <div className="div-style" style={{ borderTop: 0 }}>
              <label className="inner-div-tag">Do you have a 
Current Bank 
Account
 </label>
              <div
...
(Avg last 3 years) 
              ...
              />
              <label htmlFor="Investment_plant_machinery" className="inner-div-tag">
...
(Avg last 3 years) 
            ...
            <div className="div-style" style={{ borderTop: 0 }}>
              <label htmlFor="Investment_IT_Infrastructure" className="inner-div-tag">
              Investment in IT 
Infrastructure 
(Avg in Last 3 
Years) 
...
(Yes/ No){" "}
              ...
              <input
                ...
                style={{ width: "30%", border: "transparent" }}
              />
              <label htmlFor="Overall_Annual_production" className="inner-div-tag">
              Overall Annual 
Production:
{" "}
              </label>
            ...
            <div className="div-style" style={{ borderTop: 0 }}>
              <label htmlFor="Electric_Availability_Hours" className="inner-div-tag">
              Electricity availability for 
how many hours? 
              </label>
              <input
                type="number"
              ...
              />
              <label htmlFor="Electricity_rate_Per_Unit" className="inner-div-tag">
            ...
            <div className="div-style" style={{ borderTop: 0 }}>
              <label className="inner-div-tag">Is Water 
availability a 
constraint?</label>
              <div
                className="checkboxes"
              ...
              >
                <div>
                  <label htmlFor="Water_Availability" style={{ fontWeight: "500" }}>
                    Yes
                  </label>
                  <input
                    type="radio"
...
seminars/awareness program of the Govt. for 
MSME Sector?{" "}
              </label>
              <div className="checkboxes">
                <div>
